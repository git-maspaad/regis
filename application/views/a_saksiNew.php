          ...
          <div class="">
            <div class="x_panel">
              ...
              <div class="x_content">
                ...
                <form id="demo-form" data-parsley-validate style="font-family: 'Monaco';" method="POST" action="CreateNewSaksiPerindo">
                  ...
                  <select id="spinnerkecamatan" name="spinner_User_Kecamatan" class="form-control" style="margin-bottom: 15px;" required>
                      <option value="0" selected>Pilih</option>
                      <?php
                          # $this->load->view('a_spinnerKecamatan');
                      ?>
                  </select>
                  ...
                  <select id="spinnerkelurahan" name="spinner_User_Kelurahan" class="form-control" style="margin-bottom: 15px;" required>
                      <option value="0" selected>Pilih</option>
                      <?php
                          # $this->load->view('a_spinnerKelurahan');
                      ?>
                  </select>
                  ...
                  <input type="number" id="nomorktp" class="form-control" name="text_User_NomorKTP" data-parsley-trigger="change" value="" style="margin-bottom: 15px;" required />
