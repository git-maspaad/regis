          ...
          <div class="">
            <div class="x_panel">
              ...
              <div class="x_content">
                ...
                <form id="demo-form" data-parsley-validate style="font-family: 'Monaco';" method="POST" action="<?php echo base_url() . "Admin/UpdateKecamatan"; ?>">

                    <?php
                        $this->load->view('a_kecamatanEditGet');
                    ?>
