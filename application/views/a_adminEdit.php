          ...
          <div class="">
            <div class="x_panel">
              ...
              <div class="x_content">
                ...
                <form id="demo-form" data-parsley-validate style="font-family: 'Monaco';" method="POST" action="../UpdateAdminProfile">
                  <?php
                    $this->load->view('a_adminEditGet');
                  ?>
                </form>
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function ()
        {
            ...
            /*$("#spinnerprovinsi").change(function()
            {
                ...
                $.ajax({
                    url: '<?php #echo "../SpinnerKotaOnAjax/" ?>' + idprovinsi,
            ...
            /*$("#spinnerkota").change(function()
            {
                ...
                $.ajax({
                    url: '<?php #echo "../SpinnerKecamatanOnAjax/" ?>' + idprovinsi + '/' + idkota,
                    cache: false,
                    success: function(r)
                    {
            ...
            /*$("#spinnerkecamatan").change(function()
            {
                ...
                $.ajax({
                    url: '<?php #echo "../SpinnerKelurahanOnAjax/" ?>' + idprovinsi + '/' + idkota + '/' + idkecamatan,
                    cache: false,
                    success: function(r)
                    {
