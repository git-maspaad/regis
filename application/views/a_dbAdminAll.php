...
<html lang="en">
  ...
  <body class="nav-md">
      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><?php echo "Admin" . '&nbsp;&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;&nbsp;' . "Semua Provinsi" ?></h2>
                    <span style="color: #607D8B; float: right; margin-top: 0px;">
                        <form method="POST" action="<?php echo base_url() . "Admin/ExcelExportAdminAll"; ?>">
                  ...
                  <div class="x_content">
                    <table id="datatable" class="table table-striped table-bordered">
                      <thead>
                        <tr>
                          <th>Nama Lengkap</th>
                          <th style="width: 100px; text-align: left;">Kontak</th>
                          <th style="width: 125px; text-align: left;">Username Login</th>
                          <th style="width: 75px; text-align: left;">Status</th>
                          <!--<th>Nama Depan</th>
                          <th>Nama Belakang</th>
                          <th>Jenis Kelamin</th>
                          <th>Provinsi</th>
    ...
    <script type="text/javascript">
        ...
        function ClickDeleteAdmin (message, iduser)
        {
          $.confirm({
              text: message,
              confirm: function(button) {
                  $.ajax({
                      type: "POST",
                      url: "<?php echo base_url().'Admin/DeleteAdmin/'; ?>" + iduser,
