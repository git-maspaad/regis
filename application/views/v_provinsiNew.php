          ...
          <div class="">
            <div class="x_panel">
              ...
              <div class="x_content">
                ...
                <form id="demo-form" data-parsley-validate style="font-family: 'Monaco';" method="POST" action="<?php echo base_url() . "Dashboard/CreateNewProvinsi"; ?>">

                  <label style="font-size: 20px; margin-bottom: 15px;">Form Provinsi</label>
                  <div class="clearfix"></div>

                  <label for="idwilayah">Nama Provinsi</label>
                  <input type="text" id="provinsi" name="text_Provinsi_NamaProvinsi" class="form-control" style="margin-bottom: 15px;" value="" placeholder="..." required autofocus />

                  <label for="idwilayah">Wilayah</label>
                  <select id="idwilayah" name="spinner_Provinsi_IdWilayah" class="form-control" style="width: 150px; margin-right: 10px;" required>
                    <option value="" selected>Pilih</option>
                    <option value="1">Sumatera</option>
                    <option value="2">Jawa - Bali</option>
                    <option value="3">Kalimantan</option>
                    <option value="4">Wilayah Timur</option>
                  </select>
