      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><?php echo "Database Admin";# . '&nbsp;&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;&nbsp;' . "Semua Provinsi" ?></h2>
                    <span style="color: #607D8B; float: right; margin-top: 0px;">
                        <form method="POST" action="<?php echo base_url() . "Dashboard/ExcelExportAdminAll"; ?>">
