...
<html lang="en">
  ...
  <body class="nav-md">
      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><?php echo "Data Wilayah" . '&nbsp;&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;&nbsp;' . "Kelurahan" ?></h2>
                  ...
                  <div class="x_content">
                    <table id="datatable" class="table table-striped table-bordered">
                      <thead>
                        <tr>
                          <th>Kelurahan</th>
                          <th style="width: 17.50%">Kecamatan</th>
                          <th style="width: 17.50%;">Kab. / Kota</th>
                          <th style="width: 17.50%;">Provinsi</th>
                      ...
                      <tbody>
                        <?php
                            $this->load->view('v_dataKelurahan');
                        ?>
                      </tbody>
                    </table>
                  </div>
    ...
    <script type="text/javascript">
        ...
        function ClickDeleteKelurahan (message, idkelurahan)
        {
            $.confirm({
                text: message,
                confirm: function(button) {
                    $.ajax({
                        type: "POST",
                        url: "<?php echo base_url().'Dashboard/DeleteKelurahan/'; ?>" + idkelurahan,
