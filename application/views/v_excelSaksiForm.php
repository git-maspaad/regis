  ...
  <head>
    ...
    <script type="text/javascript">
        function CheckFileExcel(sender)
        {
            ...
            {
                $("#idFilepathExcelSaksi").val('');
                ShowMessage("Mohon upload file excel.");
          ...
          <div class="">
            <div class="x_panel">
              ...
              <div class="x_content">
                ...
                <form id="demo-form" data-parsley-validate style="font-family: 'Monaco';" method="POST" action="<?php echo base_url() . "Dashboard/ExcelSaksiProses"; ?>" enctype="multipart/form-data">

                  <label style="font-size: 20px; margin-bottom: 15px;">Upload Data Saksi</label>
                  <div class="clearfix"></div>

                  <label for="filepath">File Excel</label>
                  <input type="file" id="idFilepathExcelSaksi" name="text_FilepathExcelSaksi" accept=".xlsx, .xls, .csv" class="form-control" style="margin-bottom: 15px;" value="" placeholder="select excel file" onchange="CheckFileExcel(this)" required />
                  <!--<input type="text" id="fullname" name="text_User_NamaDepan" class="form-control" style="margin-bottom: 15px;" value="" placeholder="nama depan" required autofocus />-->
