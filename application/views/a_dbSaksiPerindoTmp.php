                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <span style="color: #607D8B; float: right; margin-top: 0px;">
                        ...
                        &nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;
                        <a href="<?php echo base_url() . "Admin/ExcelExportDbSaksiPerindoTmp"; ?>" class="btn btn-primary"><i class="fa fa-file-excel-o"></i><small>&nbsp;&nbsp;&nbsp;Export to Excel</small></a>
        ...
        function ClickDialogSubmitSaksiPerindo (message)
        {
          $.confirm({
              ...
              confirm: function(button) {
                  $.ajax({
                      type: "POST",
                      url: "<?php echo base_url().'Admin/ExcelSaksiSubmit_v2'; ?>",
                      success: function(status) {
                          console.log(status);
                          ...
                          {
                              location.reload();
                              window.location.href = "<?php echo base_url().'Admin/ExcelSaksi'; ?>";
                          }
                          else
                          {
                              window.location.href = "<?php echo base_url().'Admin/DbSaksiPerindoExcel'; ?>";
                          }
                      },
