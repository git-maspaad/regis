                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <span style="color: #607D8B; float: right; margin-top: 0px;">
                        ...
                        <!-- <a href=" #echo base_url() . "Dashboard/ExcelExportDbSaksiPerindoTmp_v2"; " class="btn btn-primary" style="margin-right: -5px;"><i class="fa fa-file-excel-o"></i><small>&nbsp;&nbsp;&nbsp;Export to Excel</small></a>-->
