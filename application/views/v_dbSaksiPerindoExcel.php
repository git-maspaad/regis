...
<html lang="en">
  ...
  <body class="nav-md">
                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <span style="color: #607D8B; float: right; margin-top: 0px;">
                        ...
                        <form method="POST" action="<?php echo base_url() . "Dashboard/ExcelExportDbSaksiPerindoTmp_v3"; ?>">
                          <strong>DAPIL&nbsp;&nbsp;</strong>
                        ...
                        <!-- <select id="idSpinnerDapil" name="spinner_User_Dapil" class="form-control" style="width: 150px; margin-right: 10px;" required> -->

                        <!--<div id="idHrefExportToExcel">
                          <a href="" class="btn btn-primary" style="margin-right: -5px; margin-top: 2.50px;"><i class="fa fa-file-excel-o"></i><small>&nbsp;&nbsp;&nbsp;Export to Excel</small></a>
                        </div>-->
    ...
    <script type="text/javascript">
        ...
        {
            //$("#idHrefExportToExcel").find('a').remove().append('<a href="www.google.com" class="btn btn-primary" style="margin-right: -5px; margin-top: 2.50px;"><i class="fa fa-file-excel-o"></i><small>&nbsp;&nbsp;&nbsp;Export to Excel</small></a>');
            //<?php #echo base_url() . "Dashboard/ExcelExportDbSaksiPerindoTmp_v2"; ?>
            ...
            $("#idSpinnerDapil").change(function()
            {
                ...
                $.ajax({
                    url: '<?php echo base_url()."Dashboard/SpinnerDapilOnAjax_v2/" ?>' + iddapil,
