...
<html lang="en">
  ...
  <body class="nav-md">
                ...
                <div class="x_panel">
                  <div class="x_title">
                    ...
                    <?php
                        ...
                        echo 'Data Caleg'.'&nbsp;&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;&nbsp;';
                        $this->m_caleg->GetTipeCalegForTitle($IdTipeCaleg);
                    ?>
                    </h2>
    ...
    <script type="text/javascript">
        ...
        function ClickDeleteCaleg (message, idcaleg)
        {
          $.confirm({
              text: message,
              confirm: function(button) {
                  $.ajax({
                      type: "POST",
                      url: "<?php echo base_url().'Dashboard/DeleteCaleg/'; ?>" + idcaleg,
