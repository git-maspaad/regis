      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><?php echo "Saksi Perindo" . '&nbsp;&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;&nbsp;' . "Semua Provinsi" ?></h2>
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      <thead>
                        <tr>
                          ...
                          <th>Alamat Rumah</th>
                          <th style="width: 100px; text-align: left;">No. Handphone</th>
                          <th>Rekomendasi</th>
                          <th style="width: 40px; text-align: left;">TPS</th>
