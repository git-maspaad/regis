          ...
          <div class="">
            <div class="x_panel">
              ...
              <div class="x_content">
                ...
                <form id="demo-form" data-parsley-validate style="font-family: 'Monaco';" method="POST" action="<?php echo base_url() . "Dashboard/CreateNewKecamatan"; ?>">

                  <label style="font-size: 20px; margin-bottom: 15px;">Form Kecamatan</label>
                  <div class="clearfix"></div>

                  <label for="spinnerprovinsi">Provinsi</label>
                  <select id="spinnerprovinsi" name="spinner_Provinsi_IdProvinsi" class="form-control" style="width: 100%; margin-bottom: 25px; margin-right: 0px;" required onclick="LoadProvinsiOnSelected()">
                      <?php
                  ...
                  <input type="text" id="kecamatan" name="text_Kecamatan_NamaKecamatan" class="form-control" style="margin-bottom: 15px;" value="" placeholder="..." required autofocus />
