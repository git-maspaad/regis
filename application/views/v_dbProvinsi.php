...
<html lang="en">
  ...
  <body class="nav-md">
      ...
      <div class="main_container">
        ...
        <div class="right_col" role="main">
          ...
          <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  <div class="x_title">
                    <h2><?php echo "Data Wilayah" . '&nbsp;&nbsp;&nbsp;<i class="fa fa-angle-right"></i>&nbsp;&nbsp;&nbsp;' . "Provinsi" ?></h2>
    ...
    <script type="text/javascript">
        ...
        function ClickDeleteProvinsi (message, idprovinsi)
        {
          $.confirm({
              text: message,
              confirm: function(button) {
                  $.ajax({
                      type: "POST",
                      url: "<?php echo base_url().'Dashboard/DeleteProvinsi/'; ?>" + idprovinsi,
