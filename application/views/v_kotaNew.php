          ...
          <div class="">
            <div class="x_panel">
              ...
              <div class="x_content">
                ...
                <form id="demo-form" data-parsley-validate style="font-family: 'Monaco';" method="POST" action="<?php echo base_url() . "Dashboard/CreateNewKota"; ?>">

                  <label style="font-size: 20px; margin-bottom: 15px;">Form Kab./Kota</label>
                  <div class="clearfix"></div>

                  <label for="provinsi">Provinsi</label>
                  <select id="provinsi" name="spinner_Provinsi_IdProvinsi" class="form-control" style="width: 100%; margin-bottom: 25px; margin-right: 0px;" required>
                    <?php
                  ...
                  <table style="margin-bottom: 0px;">
                      <th>
                        <select id="borndatemm" name="spinner_Kota_KategoriKota" class="form-control" style="width: 150px; margin-right: 10px;" required>
                      ...
                      <th width="100%">
                        <input type="text" id="kota" class="form-control" name="text_Kota_NamaKota" data-parsley-trigger="change" value="" placeholder="nama kab. / kota" style="width: 100%; text-align: left;" required autofocus />
                      </th>
                  </table>
