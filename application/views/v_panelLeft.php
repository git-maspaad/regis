<div class="col-md-3 left_col">
  <div class="left_col scroll-view">
    <div class="navbar nav_title" style="border: 0;">
        <a href="<?php echo site_url("Dashboard"); ?>" class="site_title"><img src="<?php echo base_url() ?>assets/images/img_chartbar1_32px.png" style="height: 25px; width: 25px; margin-top: -7.50px;"/> <span style="font-family: 'Arial';">Real Count</span></a>
    </div>
